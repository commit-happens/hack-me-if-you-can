...
VALUES
    ('singhaTheRulerOfAllWorlds001', 100),
    ('CyberEli', 99),
    ('NikByte', 43),
    ('ReneRoot', 77),
    ('Čičina♥', 89),
    ...
    ('xX_no0bSl4yer_Xx!!!🔥', 64),
    ('🧅🥲 cebulka_master', 5),
    ('   omylem   mezery    všude   ', 22),
    ('D3F4ULT___USR???', 71),
    ('😈💀 FINAL_BOSS_420 💀😈', 95),
    ('hej!proc_to_nefunguje??', 11),
    ('kOcOuR_žÍžAlA_88', 44),
    ('XDxdXDxdXd   ', 8),
    ('pr@šiv#ák!_69', 1),
    ('🌪️..tornado_homyx..🌪️', 76),
    ('🤖_MegaUltraBotDestroyer9000_⚡', 73),
    ('shadow_king_of_darkness_🔥💀', 42),
    ('☠️xXx_FATALITY_MASTER_3000_xXx', 12),
    ('superLongNickName_becauseWHY?!', 9),
    ('🍕HungryPlayerWhoEatsAllTime🍕', 55),
    ('ERROR_404_username_not_found😵', 87),
    ('⚔️KnightOfTheLaggingRealm_123⚔️', 14),
    ('🐸spong3b0b_m3m3_L0RD_ultimate🐸', 28),
    ('🔥🔥unlimited_power_overflow_99', 63),
    ('Too_Many_Characters_But_Fine😅', 3),
    ('Žluťoučký_Kůň✨', 12),
    ('lol_xd_🤡', 4),
    ('R@nd0mUser?!!', 39),
    ('UTF8_Šílenec💥', 27),
    ('404nicknameNotHere', 5),
    (';;;DROP_TABLE_USER;;;', 1),
    ('Čundrák_v_lese🌲', 44),
    ('za_malo😂_pane', 8),
    ('xXx_xoxo_kitty_xXx', 22),
    ('🥒nakl@dačka🥒', 9),
    ('mega⚡lagger9000', 63),
    ('žádnej_nápad😂', 14),
    ('🧅OnionSlayer🧅', 19),
    ...
    ('Z0X', 17),
    ('🔥🐸👑💀', 4),
    ('Lord_Cyber_Tatínek3000', 55),
    ('MalySniper007Pro', 21),
    ('N1ghtM4re_Ex3cut0r', 63),
    ('gͧͣ͌ͫͬl̶̶ͬi̷̸ͯt̷ͤc̶͒͗̎h͐͒͝', 8),
    ('SakraTyJsiTrdloXD', 31),
    ('"DROP TABLE users;--"', 12),
    ('P0m3l0_Quantum_Ninja', 44),
    ('🔥', 2),
    ('💀', 9),
    ('🐸', 14),
    ('?!', 3),
    ...
    ('F1reFly✨', 47),
    ('N@h0dny_Zn@k', 28),
    ('m͑ͩ̒͗͒̾̾a͐ͤ̽ͪͥͨs̓̄̋̌͂̇oͧ͊̏̍', 6),
    ('‏‏‎ ‎InvisibleBoy‎‏‏‎ ‎', 5),
    ('zero width spaces', 8),
    ('longggggggggggggggggggggggggg🤯', 11),
    ('Aͯ̄͗͆ͭͣͨ͛ͤ̋ͤ̅̎', 9),
    ('🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥', 14),
    ('line\nbreak', 4),
    ('　　　lots_of_spaces　　　', 2),
