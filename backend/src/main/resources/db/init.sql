...
VALUES
    ('singhaTheRulerOfAllWorlds001', 5432),
    ('CyberEli', 1199),
    ('NikByte', 3143),
    ('ReneRoot', 2177),
    ('Čičina♥', 1859),
    ...
    ('Cloud_buster', 1253),
    ('d1v0c4k_!!!', 1413),
    ('xX_no0bSl4yer_Xx!!!🔥', 1264),
    ('🧅🥲 cebulka_master', 235),
    ('   omylem   mezery    všude   ', 122),
    ('D3F4ULT___USR???', 3271),
    ('😈💀 FINAL_BOSS_420 💀😈', 2395),
    ('hej!proc_to_nefunguje??', 2411),
    ('kOcOuR_žÍžAlA_88', 2644),
    ('XDxdXDxdXd   ', 128),
    ('pr@šiv#ák!_69', 271),
    ('🌪️..tornado_homyx..🌪️', 4576),
    ('🤖_MegaUltraBotDestroyer9000_⚡', 3573),
    ('shadow_king_of_darkness_🔥💀', 1242),
    ('☠️xXx_FATALITY_MASTER_3000_xXx', 1512),
    ('superLongNickName_becauseWHY?!', 1919),
    ('🍕HungryPlayerWhoEatsAllTime🍕', 1055),
    ('ERROR_404_username_not_found😵', 1687),
    ('⚔️KnightOfTheLaggingRealm_123⚔️', 1214),
    ('🐸spong3b0b_m3m3_L0RD_ultimate🐸', 1828),
    ('🔥🔥unlimited_power_overflow_99', 2463),
    ('Too_Many_Characters_But_Fine😅', 2563),
    ('Žluťoučký_Kůň✨', 1612),
    ('lol_xd_🤡', 104),
    ('R@nd0mUser?!!', 1639),
    ('UTF8_Šílenec💥', 2527),
    ('404nicknameNotHere', 3035),
    (';;;DROP_TABLE_USER;;;', 1121),
    ('Čundrák_v_lese🌲', 2544),
    ('za_malo😂_pane', 2688),
    ('xXx_xoxo_kitty_xXx', 2122),
    ('🥒nakl@dačka🥒', 1009),
    ('mega⚡lagger9000', 1163),
    ('žádnej_nápad😂', 1214),
    ('🧅OnionSlayer🧅', 2519),
    ('pepeLaugh🤣', 247),
    ('mrk3v_kungfu🥋', 2633),
    ('Z0X', 2917),
    ('🔥🐸👑💀', 1044),
    ('Lord_Cyber_Tatínek3000', 2255),
    ('MalySniper007Pro', 4021),
    ('N1ghtM4re_Ex3cut0r', 3163),
    ('gͧͣ͌ͫͬl̶̶ͬi̷̸ͯt̷ͤc̶͒͗̎h͐͒͝', 208),
    ('SakraTyJsiTrdloXD', 2031),
    ('"DROP TABLE users;--"', 2612),
    ('P0m3l0_Quantum_Ninja', 2644),
    ('🔥', 362),
    ('💀', 329),
    ('🐸', 2214),
    ('?!', 223),
    ...
    ('F1reFly✨', 1247),
    ('N@h0dny_Zn@k', 1928),
    ('m͑ͩ̒͗͒̾̾a͐ͤ̽ͪͥͨs̓̄̋̌͂̇oͧ͊̏̍', 126),
    ('‏‏‎ ‎InvisibleBoy‎‏‏‎ ‎', 105),
    ('zero width spaces', 508),
    ('longggggggggggggggggggggggggg🤯', 111),
    ('Aͯ̄͗͆ͭͣͨ͛ͤ̋ͤ̅̎', 909),
    ('🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥', 2014),
    ('line\nbreak', 304),
    ('　　　lots_of_spaces　　　', 2012),
    ('RTL_‏‏‎test‏‏‎_🔥', 1117),
    ('𝕊𝕦𝕡𝕖𝕣𝔽𝕠𝕟𝕥', 1213),
    ('xss_test_escaped', 351),
    ('''quotes_everywhere''', 3312),
    ('/////////', 3066),
    ('🐛bug🐛bug🐛bug🐛', 2215),
    ('🤡ClownMode🤡', 3323),
    ('😇🙃🙂😉😏', 3017),
    ('❗❗❗ERROR❗❗❗', 2779),
    ('„‚…†‡‰Š‹ŒžŸ', 2618),
    ('emoji‍‍‍cluster‍‍‍test', 2521),
    ('dvojity̌̌test', 1510),
    ('¯\_(ツ)_/¯', 3633)
ON CONFLICT (nickname) DO NOTHING;

-- Init Phishing Categories table
INSERT INTO phishing_categories (tag, name, description, reward_points, security_hints) VALUES
    ('LEGIT',
