INSERT INTO players (id, nickname, score) VALUES (1, 'singhaTheRulerOfAllWorlds001', 100) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (2, 'CyberEli', 99) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (3, 'NikByte', 43) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (4, 'ReneRoot', 77) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (5, 'Čičina♥', 89) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (6, 'Král 🐸 žabák', 0) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (7, 'ZeroTrust', 13) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (8, '   náhodný   mezery   ', 1) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (9, 'Cloud_buster', 53) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (10, 'd1v0c4k_!!!', 13) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (11, 'xX_no0bSl4yer_Xx!!!🔥', 64) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (12, '🧅🥲 cebulka_master', 5) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (13, '   omylem   mezery    všude   ', 22) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (14, 'D3F4ULT___USR???', 71) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (15, '😈💀 FINAL_BOSS_420 💀😈', 95) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (16, 'hej!proc_to_nefunguje??', 11) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (17, 'kOcOuR_žÍžAlA_88', 44) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (18, 'XDxdXDxdXd   ', 8) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (19, 'pr@šiv#ák!_69', 1) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (20, '🌪️..tornado_homyx..🌪️', 76) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (21, '🤖_MegaUltraBotDestroyer9000_⚡', 73) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (22, 'shadow_king_of_darkness_🔥💀', 42) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (23, '☠️xXx_FATALITY_MASTER_3000_xXx', 12) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (24, 'superLongNickName_becauseWHY?!', 9) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (25, '🍕HungryPlayerWhoEatsAllTime🍕', 55) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (26, 'ERROR_404_username_not_found😵', 87) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (27, '⚔️KnightOfTheLaggingRealm_123⚔️', 14) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (28, '🐸spong3b0b_m3m3_L0RD_ultimate🐸', 28) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (29, '🔥🔥unlimited_power_overflow_99', 63) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (30, 'Too_Many_Characters_But_Fine😅', 3) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (31, 'Žluťoučký_Kůň✨', 12) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (32, 'lol_xd_🤡', 4) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (33, 'R@nd0mUser?!!', 39) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (34, 'UTF8_Šílenec💥', 27) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (35, '404nicknameNotHere', 5) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (36, ';;;DROP_TABLE_USER;;;', 1) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (37, 'Čundrák_v_lese🌲', 44) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (38, 'za_malo😂_pane', 8) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (39, 'xXx_xoxo_kitty_xXx', 22) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (40, '🥒nakl@dačka🥒', 9) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (41, 'mega⚡lagger9000', 63) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (42, 'žádnej_nápad😂', 14) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (43, '🧅OnionSlayer🧅', 19) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (44, 'pepeLaugh🤣', 7) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (45, 'mrk3v_kungfu🥋', 33) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (46, 'Z0X', 17) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (47, '🔥🐸👑💀', 4) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (48, 'Lord_Cyber_Tatínek3000', 55) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (49, 'MalySniper007Pro', 21) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (50, 'N1ghtM4re_Ex3cut0r', 63) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (51, 'gͧͣ͌ͫͬl̶̶ͬi̷̸ͯt̷ͤc̶͒͗̎h͐͒͝', 8) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (52, 'SakraTyJsiTrdloXD', 31) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (53, '"DROP TABLE users;--"', 12) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (54, 'P0m3l0_Quantum_Ninja', 44) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (55, '🔥', 2) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (56, '💀', 9) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (57, '🐸', 14) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (58, '?!', 3) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (59, '⚡', 1) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (60, 'XD', 20) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (61, '🧅', 7) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (62, '🤖', 11) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (63, '🔥🐸', 18) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (64, '_', 5) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (65, 'Q', 12) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (66, '🌀', 4) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (67, '💣BOOM', 33) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (68, 'F1reFly✨', 47) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (69, 'N@h0dny_Zn@k', 28) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (70, 'm͑ͩ̒͗͒̾̾a͐ͤ̽ͪͥͨs̓̄̋̌͂̇oͧ͊̏̍', 6) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (71, '‏‏‎ ‎InvisibleBoy‎‏‏‎ ‎', 5) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (72, 'zero width spaces', 8) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (73, 'longggggggggggggggggggggggggg🤯', 11) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (74, 'Aͯ̄͗͆ͭͣͨ͛ͤ̋ͤ̅̎', 9) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (75, '🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥', 14) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (76, 'line\nbreak', 4) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (77, '　　　lots_of_spaces　　　', 2) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (78, 'RTL_‏‏‎test‏‏‎_🔥', 7) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (79, '𝕊𝕦𝕡𝕖𝕣𝔽𝕠𝕟𝕥', 13) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (80, 'xss_test_escaped', 1) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (81, '''quotes_everywhere''', 12) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (82, '/////////', 6) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (83, '🐛bug🐛bug🐛bug🐛', 15) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (84, '🤡ClownMode🤡', 23) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (85, '😇🙃🙂😉😏', 17) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (86, '❗❗❗ERROR❗❗❗', 9) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (87, '„‚…†‡‰Š‹ŒžŸ', 18) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (88, 'emoji‍‍‍cluster‍‍‍test', 21) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (89, 'dvojity̌̌test', 10) ON CONFLICT (id) DO NOTHING;
INSERT INTO players (id, nickname, score) VALUES (90, '¯\_(ツ)_/¯', 33) ON CONFLICT (id) DO NOTHING;

-- Reset auto-increment sequence for next inserts
ALTER TABLE players ALTER COLUMN id RESTART WITH 91;

INSERT INTO platform_types (name) VALUES ('email'), ('sms');
...
jsonb_build_object('sender', 'promo@letenky-super.example', 'subject', 'Speciální nabídka: letenky od 199 € - platí jen 2 hodiny!'),
...
jsonb_build_object('sender', 'alerts@paypal-security.example', 'subject', 'Ověřte platbu - podezřelá aktivita na vašem účtu'),
...
jsonb_build_object('sender', 'support@steam-rewards.com', 'subject', 'Získali jste bonusové kredity – potvrďte převzetí'),
...
jsonb_build_object('sender', 'rcmodely-support@secure-check.com', 'subject', 'Nutná aktualizace účtu v RC Model Clubu'),
...
jsonb_build_object('sender', 'garden-support@update-panel.com', 'subject', 'Problém s objednávkou zahradního vybavení'),
...
jsonb_build_object('sender', 'support@fitness-center-security.com', 'subject', 'Pozastavené členství – nutná aktualizace údajů'),
...
jsonb_build_object('sender', 'system@sharepoint-files-secure.net', 'subject', 'Kolega s vámi sdílí dokument: ''Plán_Bonusů_2024.xlsx'''),
...
jsonb_build_object('sender', 'podpora@moje-banka-servis.eu', 'subject', 'Důležité: Vaše mobilní aplikace vyprší'),
...
jsonb_build_object('sender', 'eRecept@zdravotniportal-info.com', 'subject', 'Váš elektronický recept vyprší za 24 hodin'),
...
jsonb_build_object('sender', 'urad@mojedatovkaservis.com', 'subject', 'Zpráva ve vaší datové schránce: vyzvednutí nutné'),
...
jsonb_build_object('sender', 'hlidac-elektro@domacnost-servis.cz', 'subject', 'Hrozí přetížení domácí sítě – nutná kontrola'),
...
jsonb_build_object('sender', 'bezpecnost@moje-banka-verifikace.com', 'subject', 'DŮLEŽITÉ: Váš účet byl dočasně omezen'),
...
jsonb_build_object('sender', 'billing@ucetni-portal-pay.net', 'subject', 'Faktura 2025/118 – vyžaduje okamžitou úhradu'),
...
jsonb_build_object('sender', 'noreply@m1crosoft-security.com', 'subject', 'Vyžaduje se reset vašeho Microsoft hesla'),
...
jsonb_build_object('sender', 'ceskaposta@delivery-cz.net', 'subject', 'Doplatek 49 Kč – zásilka nemohla být doručena'),
...
jsonb_build_object('sender', 'vyherce@promo-rewards-win.com', 'subject', 'Gratulujeme! Vyhrál jste poukaz 5 000 Kč'),
...
jsonb_build_object('sender', 'fakturace@dodavatel-kancelar.net', 'subject', 'Faktura za kancelářské potřeby – splatnost DNES'),
...
jsonb_build_object('sender', 'loterie-vyhry@super-loterie.info', 'subject', 'Byli jste vylosováni! Výhra 50 000 Kč čeká'),
...
jsonb_build_object('sender', 'uctarna@nase-spolecnost-faktury.com', 'subject', 'Nezaplacená faktura – hrozí penále'),
...
jsonb_build_object('sender', 'turnaj@pinball-klub-praha.cz', 'subject', 'Pozvánka na pinballový turnaj – 25. ledna'),
...
jsonb_build_object('sender', 'lektor@jazykova-skola-bridge.cz', 'subject', 'Domácí úkol na příští hodinu angličtiny'),
