...
INSERT INTO platform_types (id, name) OVERRIDING SYSTEM VALUE VALUES
    (1, 'email'),
    (2, 'sms');
...
INSERT INTO questions (id, platform_type_id, is_phishing, difficulty, penalty, content, metadata, explanation)
