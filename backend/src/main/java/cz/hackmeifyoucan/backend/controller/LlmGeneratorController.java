...
import cz.hackmeifyoucan.backend.dto.LlmGenerateQuestionResponse;
...
import cz.hackmeifyoucan.backend.llm.LlmClient;
...
public class LlmGeneratorController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Otázka byla úspěšně vygenerována",
                    content = @Content(schema = @Schema(implementation = LlmGenerateQuestionResponse.class))),
